...
#Patch1:         git-1.6-update-contrib-hooks-path.patch
#Patch1:         git17-rh618108.patch
#Patch2:		git171-CVE-2010-3906.patch
...
%patch0 -p1
#%patch1 -p1
#%patch1 -p1 -b .rh618108
#%patch2 -p1 -b .CVE-2010-3906
...
mkdir -p %{buildroot}%{_var}/www/git/js/lib
install -pm 644 gitweb/static/*.{css,js,png} %{buildroot}%{_var}/www/git
install -pm 644 gitweb/static/js/*.js %{buildroot}%{_var}/www/git/js
install -pm 644 gitweb/static/js/lib/*.js %{buildroot}%{_var}/www/git/js/lib
