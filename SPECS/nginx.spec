...
install -p -D -m 0755 $RPM_SOURCE_DIR/nginx/nginx.init %{buildroot}%{_initrddir}/nginx
install -p -D -m 0644 $RPM_SOURCE_DIR/nginx/nginx.logrotate %{buildroot}%{_sysconfdir}/logrotate.d/nginx
install -p -D -m 0644 $RPM_SOURCE_DIR/nginx/nginx.sysconfig %{buildroot}%{_sysconfdir}/sysconfig/nginx
...
install -p -m 0644 $RPM_SOURCE_DIR/nginx/nginx.conf %{buildroot}%{nginx_confdir}
install -p -m 0644 $RPM_SOURCE_DIR/nginx/virtual.conf $RPM_SOURCE_DIR/nginx/ssl.conf $RPM_SOURCE_DIR/nginx/default.conf %{buildroot}%{nginx_confdir}/conf.d
install -p -m 0644 $RPM_SOURCE_DIR/nginx/index.html $RPM_SOURCE_DIR/nginx/poweredby.png $RPM_SOURCE_DIR/nginx/nginx-logo.png $RPM_SOURCE_DIR/nginx/404.html $RPM_SOURCE_DIR/nginx/50x.html %{buildroot}%{nginx_webroot}
